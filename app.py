...
if query:
    ...
    matched_metadata = result['source_documents'][0].metadata if result['source_documents'] else {}
    chunk_info = f"Source: {matched_metadata.get('source', 'Unknown')}, Chunk Index: {matched_metadata.get('chunk_index', 'Unknown')}"
